...
//Current season selections (manually set)
	document.getElementById("coresetimage").innerHTML = coreSetImages[9].img;
    document.getElementById("coreBg").style.backgroundImage = coreSetImages[9].bg;
	
	document.getElementById("largesetimage").innerHTML = largeSetImages[39].img;
    document.getElementById("largeBg").style.backgroundImage = largeSetImages[39].bg;
	
    document.getElementById("largesetimage2").innerHTML = largeSetImages[18].img;
    document.getElementById("largeBg2").style.backgroundImage = largeSetImages[18].bg;
	
	document.getElementById("smallsetimage").innerHTML = smallSetImages[40].img;
    document.getElementById("smallBg").style.backgroundImage = smallSetImages[40].bg;
	
	document.getElementById("smallsetimage2").innerHTML = smallSetImages[43].img;
    document.getElementById("smallBg2").style.backgroundImage = smallSetImages[43].bg;
		
	document.getElementById("smallsetimage3").innerHTML = smallSetImages[33].img;
    document.getElementById("smallBg3").style.backgroundImage = smallSetImages[33].bg;
	
	document.getElementById("smallsetimage4").innerHTML = smallSetImages[13].img;
    document.getElementById("smallBg4").style.backgroundImage = smallSetImages[13].bg;
	
	// Set the date we're counting down to
var countDownDate = new Date("Sept 29, 2022 17:00:00").getTime();
...
document.getElementById("time").innerHTML = days + " Days " + " & " + hours + " hr(s) ";
